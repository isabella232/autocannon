...
function Client (opts) {
  ...
  this.opts.expectResponse = this.opts.expectResponse || null
  ...
  // - emit 'responseMismatch' if the response doesn't match `expectResponse`
  ...
  this.parser[HTTPParser.kOnMessageComplete] = () => {
    ...
    if (
      ...
      return this.emit('responseMismatch', {
        status: resp.status,
        body: resp.body
      })
    }
